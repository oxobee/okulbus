...
public final class ItemDriverBinding implements ViewBinding {
  ...
  private ItemDriverBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnArchive,
  ...
  public static ItemDriverBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemDriverBinding((LinearLayout) rootView, btnArchive, btnEdit, btnView, imgAvatar,
